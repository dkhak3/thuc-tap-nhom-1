    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('search') }}" method="GET" class="d-none d-md-flex ms-4">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Thu</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <p>Tìm thấy {{count($lecture)}} Lecture</p>
                ...
                <tbody>
                     @foreach ($lecture as $item)
                        <tr>
                            ...
                            <td>{{$item->lecture_phone}} </td>
                            <td>{{$item->lecture_birthday}} </td>
                            <td>
                              <form action="{{ route('delete', $item->id) }}" onsubmit="return confirm('Do you want to delete?')">
                                <a  href="{{ route('editScreenLecture', $item->id) }}" class="btn btn-primary">Sửa</a>
                                @csrf
                                @method('DELETE')
            ...
            <a class="btn btn-primary " style="margin-left: 1000px;" href="{{ route('index') }}">Trở lại</a>
